        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Codice = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Area__70B820484C59AD6F", x => x.AreaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Impiegat__3214EC070141A63D", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Impiegato__AreaI__398D8EEE",
                        column: x => x.AreaId,
                        principalTable: "Area",
